 ...
 */
class Users extends \Partage\PartageBundle\Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Partage\\PartageBundle\\Entity\\Users' . "\0" . 'nom', '' . "\0" . 'Partage\\PartageBundle\\Entity\\Users' . "\0" . 'prenom', 'email', '' . "\0" . 'Partage\\PartageBundle\\Entity\\Users' . "\0" . 'adresse', '' . "\0" . 'Partage\\PartageBundle\\Entity\\Users' . "\0" . 'tel', '' . "\0" . 'Partage\\PartageBundle\\Entity\\Users' . "\0" . 'atelier', '' . "\0" . 'Partage\\PartageBundle\\Entity\\Users' . "\0" . 'participation', '' . "\0" . 'Partage\\PartageBundle\\Entity\\Users' . "\0" . 'statut', 'username', 'usernameCanonical', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function addAtelier(\Partage\PartageBundle\Entity\Atelier $atelier)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAtelier', [$atelier]);

        return parent::addAtelier($atelier);
    }
    ...
    public function removeAtelier(\Partage\PartageBundle\Entity\Atelier $atelier)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAtelier', [$atelier]);

        return parent::removeAtelier($atelier);
    }
